    ...
    private  function buildTableServiciosToEmail ($DatosAsistencia ) {
        ...
        foreach ($DatosAsistencia  as $Servicio) {
                    ...
                    $Tabla = $Tabla ."<tr>"  ;
                        ...
                        if ( trim($Servicio->actvdad_am ) == trim($Servicio->actvdad_pm )  ) {
                            $Tabla = $Tabla . "<td>" . trim($Servicio->actvdad_am )   . "</td>" ;
                        }else{
                            $Tabla = $Tabla . "<td>" . trim($Servicio->actvdad_am ) . ' ' . trim($Servicio->actvdad_pm )      . "</td>" ;
                        }
                    $Tabla = $Tabla . '</tr>';
                    $Num++;
