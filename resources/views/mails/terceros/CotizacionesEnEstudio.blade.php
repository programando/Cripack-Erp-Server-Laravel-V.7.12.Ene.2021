  ...
  <div role="article"  lang="en">
    ...
    <aside style="margin: 0 40px; margin-top: 50px;">
      <div style="text-align: justify;">
        ...
        <p>
               {{ $NomCliente}} ha indicado que la referencia : <strong> {{ $Referencia }} </strong> aún se encuentra en fase de estudio y/o aprobación.
          </p>
        <br>
    ...
    <div style="margin: 0 0px; margin-top: 50px;">
      <h4 style="font-weight: 500;"><span>
       Confirmación generada desde el correo que recibió el cliente. <br><br>  </span></h4>
    </div>
  </div>
  <footer>
    <br><br><br><br><br><br>
